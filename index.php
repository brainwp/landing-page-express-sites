...
<html lang="pt-br">
    <head>
        ...
        <!-- HTML Meta Tags -->
        <title>Brasa Design || Seu site a poucos cliques!</title>
    ...
    <body>
        <header class="header-main">
            <nav class="primary-menu">
                <div class="container">
                    <img src="https://brasa.art.br/wp-content/uploads/2019/05/favicon-300x300.png" alt="Logo da Brasa Design" class="logo">
                    <ul>
        ...
        <section id="what-is">
            <div class="container">
                <div>
                    <h2>O que é?</h2>
                    <p>
                    Sed sagittis sollicitudin vulputate. Vestibulum semper pretium pharetra. Nam turpis neque, sagittis at ipsum non, feugiat eleifend ipsum. Maecenas tristique eget magna eget sollicitudin. In rutrum blandit gravida. Sed quis tempus lacus, a ultrices est. Maecenas justo enim, mattis at varius condimentum.
                    </p>
                </div>
            </div><!-- /.container -->
        </section><!-- /#what-is -->
